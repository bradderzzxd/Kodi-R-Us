...
base='http://www.KodiRUs.com'
ADDON=xbmcaddon.Addon(id='plugin.video.KodiRUs')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/nt7OgGGN1oTUpus7').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Kodi'R'Us Wizard","Downloading ",'', 'Please Wait')
